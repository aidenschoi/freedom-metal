...
/*! @brief Initialize cache controller with specified ways.
 * @param ways Number of ways to be enabled.
 * @return 0 If no error.*/
int sifive_ccache0_init(uint32_t ways);

/*! @brief Get cache configuration data.
 * @param None.
 * @return Cache controller configuration data.*/
sifive_ccache0_config *sifive_ccache0_get_config(void);

/*! @brief Get currently active cache ways.
 * @param None.
 * @return Number of cache ways enabled.*/
int sifive_ccache0_get_enabled_ways(void);
...
int sifive_ccache0_get_ecc_fix_count(sifive_ccache0_ecc_errtype_t type);
...
int sifive_ccache0_get_ecc_fail_count(sifive_ccache0_ecc_errtype_t type);
